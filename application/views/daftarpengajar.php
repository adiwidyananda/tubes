...
<body>
	...
	<center>
		<h3 style="color: #272727;padding-top: 150px;"><b>DAFTAR PENGAJAR</b></h3>
		<div class="line">
		    <div class="titik"></div>
		</div>
		 <p>Berikut adalah pendaftaran yang dapat anda isi untuk dapat mendaftar di  <span style="color:#d64545;">EXPERT COURSE.</span></p>
	</center>
	<form method="post" style="margin-top: 100px;" action="<?= base_url() ?>index.php/Pengajar/proses_tambah">
  			...
  			<div class="row">
				...
				<label><i class='fas fa-star' style="color: red;font-size: 6px;margin-left: 10px; margin-right: 5px;"></i><b style=" color:#64686d; font-size: 14px;">Universitas<b></label></br>
                    ...
                    <label><i class='fas fa-star' style="color: red;font-size: 6px;margin-left: 10px; margin-right: 5px;"></i><b style=" color:#64686d; font-size: 14px;">Pilih Mata Kuliah<b></label></br>
                        <div style="margin-left: 10px; width: 530px;" class="input-group mb-3">
                         <select name="matkul" style="width: 100%">
                             <option selected>Pilih Mata Kuliah</option>
                         </select>
                    </div>
                    <label><i class='fas fa-star' style="color: red;font-size: 6px;margin-left: 10px; margin-right: 5px;"></i><b style=" color:#64686d; font-size: 14px;">Upload Foto<b></label></br>
                        <div style="margin-left: 10px; width: 530px;" class="input-group mb-3">
                         <select name="foto" style="width: 100%">
