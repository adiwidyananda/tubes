      ...
      <div class="row">
        ...
        <div class="col-sm-6">
          ...
          <div class="form">
            ...
            <button style="font-size: 14px; width: 180px;height: 35px; border-bottom: 3px solid #be2a2a; border-radius: 3px;" type="button" class="btn btn-danger"><i class='fas fa-user' style="margin-right: 5px;"></i>Mahasiswa</button><a href="<?= base_url() ?>index.php/Home/loginpengajar"><button style=" font-size: 14px; width: 180px; height: 35px; border-bottom: 3px solid #adadad; border-radius: 3px;" type="button" class="btn btn-secondary">Pengajar</button></a>
            <form method="post" style="margin-top: 40px;" action="<?= base_url() ?>index.php/Login/proses_login">
              <center>
                <div class="input-ctr" >
          ...
          <p>Belum punya akun ? <button style="border-bottom: 3px solid #adadad; height: 35px;" type="button" class="btn btn-secondary">Daftar</button></p>
